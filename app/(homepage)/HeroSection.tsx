...
export default function HeroSection(): JSX.Element {
  ...
  return (
    <div className="relative flex items-start justify-center w-full min-h-screen pt-16 overflow-hidden bg-gradient-to-br dark:from-orange-700 dark:to-orange-900 dark:via-orange-800 from-orange-400 via-orange-500 to-orange-600">
      ...
      >
        {/* Left content */}
        <div className="flex items-center md:items-start flex-col w-full gap-y-8 md:max-w-lg">
          <div className="space-y-4 text-center md:text-left">
            ...
            {/* Description */}
            <motion.p
              className="max-w-lg text-base leading-7 text-white/90 font-poppins drop-shadow-lg"
              variants={itemVariants}
            >
