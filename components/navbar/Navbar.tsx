...
const Navbar: React.FC<NavbarProps> = ({
    ...
    return (
        <header
            className={`fixed overflow-hidden top-0 z-50 w-full transition-all duration-500 ease-in-out ${
                isScrolled
                    ? 'bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm shadow-lg border-b border-gray-200/50 dark:border-gray-700/50'
                    : 'bg-gradient-to-t from-orange-500/30 via-orange-200/20 to-orange-600/30 dark:from-orange-700/10 dark:via-orange-800/30 dark:to-orange-900/50 backdrop-blur-sm shadow-none border-none'
            }`}
        >
            ...
            <div className={`absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-orange-400/60 to-transparent transition-opacity duration-500 ${
